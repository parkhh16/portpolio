...
>((props, ref) => {
  ...
  const next = useCallback(() => {
    ...
    const nextIndex = currentTextIndex === lastIndex ? (loop ? 0 : currentTextIndex) : currentTextIndex + 1
  ...
  const previous = useCallback(() => {
    const lastIndex = texts.length - 1
    const prevIndex = currentTextIndex === 0 ? (loop ? lastIndex : currentTextIndex) : currentTextIndex - 1
